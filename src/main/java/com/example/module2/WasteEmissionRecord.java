...
@Entity(tableName = "waste_emission_records")
public class WasteEmissionRecord {
    ...
    public WasteEmissionRecord(String wasteType, double quantity, double co2Emission, String date) {
