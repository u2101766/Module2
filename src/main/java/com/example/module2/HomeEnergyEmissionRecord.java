...
@Entity(tableName = "home_energy_emission_records")
public class HomeEnergyEmissionRecord {
    ...
    public HomeEnergyEmissionRecord(double quantity, double co2Emission, String date) {
    ...
    public String toString() {
        return "HomeEnergyEmissionRecord{" +
                "id=" + id +
                ", quantity=" + quantity +
