...
@Entity(tableName = "food_emission_records")
public class FoodEmissionRecord {
    ...
    public FoodEmissionRecord(String foodType, double quantity, double co2Emission, String date) {
